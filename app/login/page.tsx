      ...
      <div className="bg-white p-8 rounded-lg shadow-md w-96 z-10">
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-4 py-2 border border-gray-300 rounded-md shadow-xs bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
